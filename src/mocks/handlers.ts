...
const User = [
  { id: 'elonmusk', nickname: 'Elon Musk', avatar: '/yRsRRjGO.jpg' },
  { id: 'zerohch0', nickname: '제로초', avatar: '/5Udwvqim.jpg' },
  { id: 'leoturtle', nickname: '레오', avatar: faker.image.avatar() },
  { id: 'hwpark', nickname: 'Bob Park', avatar: faker.image.avatar() },
];
const Posts = [];
